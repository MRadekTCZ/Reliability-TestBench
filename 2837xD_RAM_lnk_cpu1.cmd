...
SECTIONS
{
   ...
   .text            : >> RAMD0 | RAMLS0 | RAMLS1 | RAMLS2 | RAMLS3 |
                         RAMLS4 | RAMLS5 |
                         RAMGS11 | RAMGS12 | RAMGS13 | RAMGS14 | RAMGS15,
                         PAGE = 0
    ...
    *
    * Important:
    * .const was too large for RAMGS8 + RAMGS9 + RAMD1.
    * It now gets RAMGS8 + RAMGS9 + RAMGS10 + RAMD1.
    */

   .bss             : >> RAMGS6 | RAMGS7, PAGE = 1

   .bss:output      : > RAMLS3, PAGE = 0

   .init_array      : > RAMM0, PAGE = 0

   .const           : >> RAMGS8 | RAMGS9 | RAMGS10 | RAMD1, PAGE = 1

   .data            : >> RAMGS0 | RAMGS1 | RAMGS2 | RAMGS3 |
                         RAMGS4 | RAMGS5,
                         PAGE = 1
   ...
   .ebss            : >> RAMGS0 | RAMGS1 | RAMGS2 | RAMGS3 |
                         RAMGS4 | RAMGS5 | RAMGS6 | RAMGS7,
                         PAGE = 1

   .econst          : >> RAMGS8 | RAMGS9 | RAMGS10 | RAMD1, PAGE = 1
   ...
   /*
    * User / example sections.
    * These are kept in GS RAM. If any of these are very large,
    * they can still collide with .data, so check the .map file
    * after building.
    */
